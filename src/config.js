    ...
    "criteria": [
        {
            ...
            "guidance": "Implement and verify funnel hypothesis map with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify simple sales input sheet with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify leak prioritization rubric with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "experiment-plan",
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify experiment plan with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-quality",
